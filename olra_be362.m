...
cd G:/for_lais;
%
ncdisp('be362.jan-dec_dmeans_ts.years1-30.olr.nc');
%360-day calendar. The year is made of 12 months, each of which has 30 days  
%10800 days in 30 years (30 * 360 = 10800)
%
olr = ncread('be362.jan-dec_dmeans_ts.years1-30.olr.nc',...
    'toa_outgoing_longwave_flux'); 
%
lat = ncread('be362.jan-dec_dmeans_ts.years1-30.olr.nc','latitude');
%
lon = ncread('be362.jan-dec_dmeans_ts.years1-30.olr.nc','longitude');
%
