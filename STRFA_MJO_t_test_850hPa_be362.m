...
%
load STRFA_850hPa_MJO; load STRFA_850hPa_DJF;
%
...
cd G:/Lais_jasmin/u-be362/data/STRF_850hPa
%
save rho_STRF_850hPa rho rho_DJF
%
%load rho_STRF_850hPa
%
...
%
save('STRFA_MJO_850hPa_comp','STRFA_MJO_m','Y','lat','lon',...
    'lat1','lon1','STRFA_MJO_std','N','-v7.3');
%
