...
colormap(map);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,7)',[-9*10^6:6*10^5:-9*10^4]);
set(gcf,'renderer','zbuffer');
set(h,'color',[0 0 0.43],'linewidth',1);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,7)',[9*10^4:6*10^5:9*10^6]);
...
%
%Colorbar------------------------------------------------------------------
m = colorbar('Position',[ 0.50 0.42 0.016 0.42 ]);
...
colormap(map);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,8)',[-9*10^6:6*10^5:-9*10^4]);
set(gcf,'renderer','zbuffer');
set(h,'color',[0 0 0.43],'linewidth',1);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,8)',[9*10^4:6*10^5:9*10^6]);
set(h,'color',[0.7 0 0],'linewidth',1);
%
axis([x1 x2 y1 y2]); hold on; set(gca,'Fontsize',12);
m_coast1('linestyle','-','color','k','linewidth',1);
...
colormap(map);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,1)',[-9*10^6:6*10^5:-9*10^4]);
set(gcf,'renderer','zbuffer');
set(h,'color',[0 0 0.43],'linewidth',1);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,1)',[9*10^4:6*10^5:9*10^6]);
set(h,'color',[0.7 0 0],'linewidth',1);
%
axis([x1 x2 y1 y2]); hold on; set(gca,'Fontsize',12);
m_coast1('linestyle','-','color','k','linewidth',1);
...
colormap(map);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,3)',[-9*10^6:6*10^5:-9*10^4]);
set(gcf,'renderer','zbuffer');
set(h,'color',[0 0 0.43],'linewidth',1);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,3)',[9*10^4:6*10^5:9*10^6]);
set(h,'color',[0.7 0 0],'linewidth',1);
%
axis([x1 x2 y1 y2]); hold on; set(gca,'Fontsize',12);
m_coast1('linestyle','-','color','k','linewidth',1);
...
colormap(map);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,4)',[-9*10^6:6*10^5:-9*10^4]);
set(gcf,'renderer','zbuffer');
set(h,'color',[0 0 0.43],'linewidth',1);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,4)',[9*10^4:6*10^5:9*10^6]);
set(h,'color',[0.7 0 0],'linewidth',1);
%
axis([x1 x2 y1 y2]); hold on; set(gca,'Fontsize',12);
m_coast1('linestyle','-','color','k','linewidth',1);
