...
cd G:/for_lais;
%
ncdisp('be362.jan-dec_dmeans_ts.years1-30.precip.nc');
%360-day calendar. The year is made of 12 months, each of which has 30 days  
%10800 days in 30 years (30 * 360 = 10800)
%
precf = ncread('be362.jan-dec_dmeans_ts.years1-30.precip.nc',...
    'precipitation_flux'); 
%
lat = ncread('be362.jan-dec_dmeans_ts.years1-30.precip.nc','latitude');
%
lon = ncread('be362.jan-dec_dmeans_ts.years1-30.precip.nc','longitude');
%
%Cutting the matrix for the South America region:
%
lat = lat(29:86); lat1 = lat;
lon = lon(147:176); lon1 = lon;
%
precf = precf(147:176,29:86,:);
%
