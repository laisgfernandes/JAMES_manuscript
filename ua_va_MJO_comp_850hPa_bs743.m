...
%
%load ua_MJO_comp_EN; load va_MJO_comp_EN;
%load ua_MJO_comp_LN; load va_MJO_comp_LN;
load ua_MJO_comp_NT; load va_MJO_comp_NT;
%
%MJO_01--------------------------------------------------------------------
%
fig = figure;
...
%print(fig,'WIND_850hPa_EN.png','-dpng');
%print(fig,'WIND_850hPa_LN.png','-dpng');
print(fig,'WIND_850hPa_NT.png','-dpng');
