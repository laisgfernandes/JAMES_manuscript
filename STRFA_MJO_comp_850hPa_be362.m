...
clear
%
cd G:/Lais_jasmin/u-be362/data/STRF_850hPa
%
load STRFA_MJO_850hPa_comp
%
%MJO_01--------------------------------------------------------------------
%
fig = figure;
...
colormap(map);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,1)',[-9*10^6:3*10^5:-9*10^4]);
set(gcf,'renderer','zbuffer');
set(h,'color',[0 0 0.43],'linewidth',1);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,1)',[9*10^4:3*10^5:9*10^6]);
...
%
%Colorbar------------------------------------------------------------------
m = colorbar('Position',[ 0.90 0.52 0.016 0.42 ]);
...
colormap(map);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,2)',[-9*10^6:3*10^5:-9*10^4]);
set(gcf,'renderer','zbuffer');
set(h,'color',[0 0 0.43],'linewidth',1);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,2)',[9*10^4:3*10^5:9*10^6]);
set(h,'color',[0.7 0 0],'linewidth',1);
%
axis([x1 x2 y1 y2]); hold on; set(gca,'Fontsize',12);
m_coast1('linestyle','-','color','k','linewidth',1);
...
colormap(map);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,3)',[-9*10^6:3*10^5:-9*10^4]);
set(gcf,'renderer','zbuffer');
set(h,'color',[0 0 0.43],'linewidth',1);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,3)',[9*10^4:3*10^5:9*10^6]);
set(h,'color',[0.7 0 0],'linewidth',1);
%
axis([x1 x2 y1 y2]); hold on; set(gca,'Fontsize',12);
m_coast1('linestyle','-','color','k','linewidth',1);
...
colormap(map);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,4)',[-9*10^6:3*10^5:-9*10^4]);
set(gcf,'renderer','zbuffer');
set(h,'color',[0 0 0.43],'linewidth',1);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,4)',[9*10^4:3*10^5:9*10^6]);
set(h,'color',[0.7 0 0],'linewidth',1);
%
axis([x1 x2 y1 y2]); hold on; set(gca,'Fontsize',12);
m_coast1('linestyle','-','color','k','linewidth',1);
...
colormap(map);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,5)',[-9*10^6:3*10^5:-9*10^4]);
set(gcf,'renderer','zbuffer');
set(h,'color',[0 0 0.43],'linewidth',1);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,5)',[9*10^4:3*10^5:9*10^6]);
set(h,'color',[0.7 0 0],'linewidth',1);
%
axis([x1 x2 y1 y2]); hold on; set(gca,'Fontsize',12);
m_coast1('linestyle','-','color','k','linewidth',1);
...
colormap(map);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,6)',[-9*10^6:3*10^5:-9*10^4]);
set(gcf,'renderer','zbuffer');
set(h,'color',[0 0 0.43],'linewidth',1);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,6)',[9*10^4:3*10^5:9*10^6]);
set(h,'color',[0.7 0 0],'linewidth',1);
%
axis([x1 x2 y1 y2]); hold on; set(gca,'Fontsize',12);
m_coast1('linestyle','-','color','k','linewidth',1);
...
colormap(map);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,7)',[-9*10^6:3*10^5:-9*10^4]);
set(gcf,'renderer','zbuffer');
set(h,'color',[0 0 0.43],'linewidth',1);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,7)',[9*10^4:3*10^5:9*10^6]);
set(h,'color',[0.7 0 0],'linewidth',1);
%
axis([x1 x2 y1 y2]); hold on; set(gca,'Fontsize',12);
m_coast1('linestyle','-','color','k','linewidth',1);
...
colormap(map);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,8)',[-9*10^6:3*10^5:-9*10^4]);
set(gcf,'renderer','zbuffer');
set(h,'color',[0 0 0.43],'linewidth',1);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,8)',[9*10^4:3*10^5:9*10^6]);
set(h,'color',[0.7 0 0],'linewidth',1);
%
axis([x1 x2 y1 y2]); hold on; set(gca,'Fontsize',12);
m_coast1('linestyle','-','color','k','linewidth',1);
...
print(fig,'STRF2_850hPa.png','-dpng');
%
