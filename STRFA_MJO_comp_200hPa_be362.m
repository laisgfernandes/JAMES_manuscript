...
colormap(map);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,2)',[-12*10^6:12*10^5:-12*10^4]);
set(gcf,'renderer','zbuffer');
set(h,'color',[0 0 0.43],'linewidth',1);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,2)',[12*10^4:12*10^5:12*10^6]);
set(h,'color',[0.7 0 0],'linewidth',1);
%
axis([x1 x2 y1 y2]); hold on; set(gca,'Fontsize',12);
m_coast1('linestyle','-','color','k','linewidth',1);
...
colormap(map);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,5)',[-12*10^6:12*10^5:-12*10^4]);
set(gcf,'renderer','zbuffer');
set(h,'color',[0 0 0.43],'linewidth',1);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,5)',[12*10^4:12*10^5:12*10^6]);
set(h,'color',[0.7 0 0],'linewidth',1);
%
axis([x1 x2 y1 y2]); hold on; set(gca,'Fontsize',12);
m_coast1('linestyle','-','color','k','linewidth',1);
...
colormap(map);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,6)',[-12*10^6:12*10^5:-12*10^4]);
set(gcf,'renderer','zbuffer');
set(h,'color',[0 0 0.43],'linewidth',1);
hold on
[C,h]=contour(x,y,STRFA_MJO_m(:,:,6)',[12*10^4:12*10^5:12*10^6]);
set(h,'color',[0.7 0 0],'linewidth',1);
%
axis([x1 x2 y1 y2]); hold on; set(gca,'Fontsize',12);
m_coast1('linestyle','-','color','k','linewidth',1);
...
print(fig,'STRF2_200hPa.png','-dpng');
%
