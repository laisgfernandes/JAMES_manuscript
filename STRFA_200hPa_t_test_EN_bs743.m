...
%
load STRFA_200hPa_MJO_EN; load STRFA_200hPa_DJF;
%
...
%
STRFA_MJO_3 = [STRFA_MJO_3(:,:); NaN(dif(3),I*J)];
%
...
%
cd G:/Lais_jasmin/u-bs743/data/STRF_200hPa
save('STRFA_MJO_comp_EN','STRFA_MJO_m','STRFA_MJO_std','N',...
